    ...
    <div className="min-h-screen" style={{ backgroundColor: '#e5e3da' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        >
          ...
          <div className="mt-4 pt-4 flex flex-wrap items-center justify-center gap-4 sm:gap-6" style={{ borderTop: '1px solid #e5e3da' }}>
            <span className="text-xs" style={{ color: '#787060' }}>Follow for STR tips:</span>
            <Link 
              href="https://instagram.com/jeffchheuy"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full transition-all hover:opacity-80"
            ...
            >
              ...
              <span className="text-xs px-1.5 py-0.5 rounded-full" style={{ backgroundColor: '#e5e3da', color: '#787060' }}>15K</span>
            </Link>
            <Link 
