      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            {county ? `${county} County` : ''} {county ? '·' : ''} Market Score: {score}/100
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '13px', color: '#9a9488' }}>
            &bull; {scoreNum >= 75 ? 'Top-rated market' : scoreNum >= 55 ? 'Solid market opportunity' : 'Emerging market'} for STR investing
          </div>
          <div style={{
            display: 'flex',
            alignItems: 'center',
