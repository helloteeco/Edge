    ...
    <div className="min-h-screen pb-24" style={{ backgroundColor: '#e5e3da' }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        >
          ...
          {/* Coaching pathway alongside Zillow */}
          <div className="mt-4 p-3.5 rounded-xl" style={{ background: 'linear-gradient(135deg, #2b2823 0%, #3d3a34 100%)' }}>
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'rgba(34, 197, 94, 0.2)' }}>
                <svg className="w-5 h-5" style={{ color: '#22c55e' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div className="flex-1">
                <p className="font-semibold text-sm" style={{ color: '#ffffff' }}>Want Jeff&apos;s Team to Help You Close?</p>
                <p className="text-xs" style={{ color: 'rgba(255,255,255,0.65)' }}>Our coaching students get matched with vetted agents and STR-friendly lenders</p>
              </div>
              <a
