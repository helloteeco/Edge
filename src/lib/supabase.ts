...
// Use service_role key for server-side operations (bypasses RLS); fall back to anon key for safety
...
// Create Supabase client (server-side only — never expose to browser)
